...
class Note {
  constructor(public data: Memo[] = [{ data: "Moonhalo", author: "saltyaom" }]) {}
...
export const note = new Elysia({ prefix: "/note" })
  ...
  .get("/", ({ note }) => note.data)
  .use(getUserId)
  .put("/", ({ note, body: { data }, username }) => note.add({
    data,
    author: username
  }), {
    body: "memo",
    detail: {
      description: `<p>This lets you add a note to the list</p>
      <p>This endpoint requires a valid session cookie</p>`
    }
  })
